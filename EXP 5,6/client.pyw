...
def ClickAction():
    ...
    s.sendall(EntryText.encode('utf-8'))
...
ChatLog.insert(END, "Connecting to your Loki..\n")
...
SendButton = Button(base, font=30, text="Send", width="12", height=5,
                    bd=0, bg="#34ebc0", activebackground="#eb3434",
                    command=ClickAction)
...
def ReceiveData():
    ...
    while 1:
        try:
            ...
            break
        if data != '':
            LoadOtherEntry(ChatLog, data.decode('utf-8'))
